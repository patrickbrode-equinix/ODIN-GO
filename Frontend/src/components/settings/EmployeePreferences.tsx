...
const COPY = {
  de: {
    ...
    preferredShiftsHelp: 'Wähle die Schichten, die du bevorzugst. Die Planung versucht, dich diesen Schichten zuzuordnen. COLO gilt für Werktags-Vorbereitung (Früh), Nacht-Colo und Wochenend-Einsätze (Früh) innerhalb des administrativ gepflegten Kompetenzpools.',
  ...
  en: {
    ...
    preferredShiftsHelp: 'Choose the shifts you prefer. Planning will try to assign you to these shifts. COLO covers weekday preparation (early), night Colo and weekend work (early) within the administrator-managed competence pool.',
